        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center card-hover bg-[#FAF7F2] p-8 rounded-2xl">
              ...
              <h3 className="text-2xl font-bold text-[#333333] mb-4">{t('home.why_choose.eco_friendly')}</h3>
            ...
            <div className="text-center card-hover bg-[#FAF7F2] p-8 rounded-2xl">
              ...
              <h3 className="text-2xl font-bold text-[#333333] mb-4">{t('home.why_choose.premium_quality')}</h3>
              <p className="text-gray-600">
            ...
            <div className="text-center card-hover bg-[#FAF7F2] p-8 rounded-2xl">
              ...
              <h3 className="text-2xl font-bold text-[#333333] mb-4">{t('home.why_choose.fast_delivery')}</h3>
              <p className="text-gray-600">
            ...
            <div className="text-center card-hover bg-[#FAF7F2] p-8 rounded-2xl">
              ...
              <h3 className="text-2xl font-bold text-[#333333] mb-4">{t('home.why_choose.trusted')}</h3>
              <p className="text-gray-600">
          ...
          <div className="max-w-4xl mx-auto">
            <div className="relative">
              <div className="bg-[#FAF7F2] rounded-2xl p-8 md:p-12 text-center">
                ...
                <blockquote className="text-xl md:text-2xl text-[#333333] mb-6 leading-relaxed">
                  "{testimonials[currentTestimonial].text}"
                </blockquote>
                <div>
                  <h4 className="text-xl font-bold text-[#333333]">
              ...
              >
                <ChevronLeft className="text-[#333333]" size={24} />
              </button>
              <button
              ...
              >
                <ChevronRight className="text-[#333333]" size={24} />
              </button>
            </div>
