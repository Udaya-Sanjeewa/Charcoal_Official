            ...
            <div>
              ...
              <div className="flex flex-col sm:flex-row gap-4 mb-8">
                <button
                  ...
                  className="flex-1 bg-[#7BB661] hover:bg-[#6B4E3D] text-white py-6 px-6 rounded-xl font-semibold text-lg flex items-center justify-center gap-2 transition-all duration-300"
                >
                ...
                <Link
                  href="/contact"
                  className="flex-1 border-2 border-[#7BB661] text-[#7BB661] hover:bg-[#7BB661] hover:text-white py-6 px-6 rounded-xl font-semibold text-lg flex items-center justify-center gap-2 transition-all duration-300"
                >
