...
export default function PremiumOakFirewood() {
  ...
  const product = {
    ...
    unit: "per cord",
    category: "Firewood",
    description: "Our premium oak firewood is carefully selected and seasoned for 12+ months to ensure optimal burning performance. Perfect for home heating, cozy fireplace evenings, and outdoor fire pits.",
    ...
    features: [
      ...
      "Low moisture content (below 20%)",
      "High heat output (24-28 million BTUs per cord)",
      "Clean burning with minimal smoke",
      "Hand-selected premium oak",
      "Kiln-dried available upon request"
    ],
    specifications: {
      "Wood Type": "Premium Oak (Quercus species)",
      "Moisture Content": "Below 20%",
      "Seasoning Time": "12+ months",
      "Heat Output": "24-28 million BTUs per cord",
      "Cord Dimensions": "4' x 4' x 8' (128 cubic feet)",
      "Piece Length": "16-18 inches standard"
    },
    images: [
    ...
    benefits: [
      "Longer burning time compared to softwoods",
      "Consistent heat output throughout burn",
      ...
      <section className="py-16 bg-[#333333] text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8 max-w-2xl mx-auto">
            Contact us today for competitive pricing and fast delivery of premium oak firewood.
          </p>
